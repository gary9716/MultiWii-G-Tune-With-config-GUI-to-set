...
#define MSP_TURN_G_TUNE_ON_OR_OFF 80   //in message
...
void evaluateCommand() {
  ...
  switch(cmdMSP[CURRENTPORT]) {
   ...
   case MSP_DEBUGMSG:
     ...
     break;
   #endif
   case MSP_TURN_G_TUNE_ON_OR_OFF:
     //rcOptions[BOXGTUNE] = 1 - rcOptions[BOXGTUNE];
     openGTUNEModeDirectly = 1 - openGTUNEModeDirectly;
     break;
